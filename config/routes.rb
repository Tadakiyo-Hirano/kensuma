...
Rails.application.routes.draw do # rubocop:disable Metrics/BlockLength
  ...
  namespace :users do
    ...
    resources :orders, param: :site_uu_id do
      ...
      resources :field_fires, except: %i[new show edit update], module: :orders, param: :uuid do
        collection do
          get 'edit_fires'
          patch 'update_fires'
        end
    ...
    resources :request_orders, only: %i[index show edit update], param: :uuid do
      ...
      resources :field_fires, except: %i[new show edit update], module: :request_orders, param: :uuid do
        collection do
          get 'edit_fires'
          patch 'update_fires'
        end
