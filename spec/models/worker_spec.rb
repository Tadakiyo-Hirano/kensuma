...
RSpec.describe Worker, type: :model do
  ...
  describe 'バリデーションについて' do
    ...
    describe '#responsible_director' do
      context '外国人である場合' do
        before :each do
          subject.country = "ネパール"
        end
        ...
        context '存在しない場合' do
          before :each do
            subject.responsible_director = nil
          end
    ...
    describe '#responsible_name' do
      context '外国人である場合' do
        ...
        context '存在しない場合' do
          ...
          it 'バリデーションのエラーが正しいこと' do
            subject.valid?
            expect(subject.errors.full_messages).to include('責任者氏名を入力してください')
          end
        end
      end
    ...
    describe '#responsible_contact_address' do
      context '外国人である場合' do
        before :each do
          subject.country = "ネパール"
        end
        ...
        context '存在しない場合' do
          before :each do
            subject.responsible_contact_address = nil
          end
          ...
          it 'バリデーションのエラーが正しいこと' do
            subject.valid?
            expect(subject.errors.full_messages).to include('責任者連絡先(TEL)を入力してください')
          end
        end
      end
