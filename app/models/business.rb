class Business < ApplicationRecord
  ...
  # 健康保険(事業所整理記号及び事業所番号) 一旦6桁から8桁で保存可能として実装
  validates :business_health_insurance_office_number, allow_blank: true, format: { with: /\A\d{6,8}\z/, message: 'は数字6桁または8桁で入力してください' }
