class Business < ApplicationRecord
  ...
  validates :branch_address, presence: true, unless: Proc.new { |b| b.branch_name.blank? }
  ...
  validates :branch_name, presence: true, unless: Proc.new { |b| b.branch_address.blank? }
  ...
  validates :business_health_insurance_office_number, length: { is: 8, message: '(健康保険)は数字8桁で入力してください' }, allow_blank: true # 健康保険(事業所整理記号及び事業所番号)
