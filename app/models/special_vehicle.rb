class SpecialVehicle < ApplicationRecord
  ...
  validates :personal_insurance, length: { maximum: 9 }
  validates :objective_insurance, length: { maximum: 9 }
  validates :passenger_insurance, length: { maximum: 9 }
  validates :other_insurance, length: { maximum: 9 }
